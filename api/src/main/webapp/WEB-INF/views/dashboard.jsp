...
<head>
    ...
    <link href="resources/css/base.css?v=v8.0.4" rel="stylesheet" type="text/css"/>
    <link href="resources/css/crapApi.css?v=v8.0.4" rel="stylesheet" type="text/css"/>
    <link href="resources/css/setting.css?v=v8.0.4" rel="stylesheet" type="text/css"/>
    <title>${title}</title>
</head>
<body class="BGFFF">
<!-- top navbar -->
...
<script src="resources/js/core.js?v=v8.0.4"></script>
<script src="resources/js/crapApi.js?v=v8.0.4"></script>
</body>
</html>
