...
public class InterfaceController extends BaseController{
	...
	public JsonResult detail(String id, String moduleId, String projectId) throws MyException {
        ...
        checkPermission(model.getProjectId(), PremissionEnum.READ);
	...
	public JsonResult copy(@RequestParam String id, String interfaceName, String url, String moduleId) throws MyException, IOException {
		...
		//判断是否拥有原来项目的权限
		checkPermission(interFace.getProjectId(), PremissionEnum.READ);
        Project project = getProject(interFace.getProjectId(), moduleId);
        Module module = moduleCache.get(moduleId);
		// 检查新项目的权限
        checkPermission(project, PremissionEnum.ADD_INTER);
	...
	public JsonResult addOrUpdate(@ModelAttribute InterfaceDto dto, String modifyRemark) throws IOException, MyException {
        ...
        if (id != null) {
			...
			// 判断是否有修改模块的权限
			checkPermission(oldProjectId, PremissionEnum.READ);
            checkPermission(newProjectId, PremissionEnum.MOD_INTER);
			...
			checkPermission(interFace.getProjectId(), PremissionEnum.ADD_INTER);
	...
	public JsonResult delete(String id, String ids) throws MyException, IOException{
		...
		for(String tempId : ids.split(",")){
			...
			checkPermission(interFace.getProjectId(), PremissionEnum.DEL_INTER);
	...
	public JsonResult changeSequence(@RequestParam String id,@RequestParam String changeId) throws MyException {
		...
		checkPermission(model.getProjectId(), PremissionEnum.MOD_INTER);
		checkPermission(change.getProjectId(), PremissionEnum.MOD_INTER);
