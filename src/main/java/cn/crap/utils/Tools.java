...
public class Tools {
    public static void staticize(String html, String filePath) throws MyException, IOException {
        ...
        OutputStreamWriter fw = new OutputStreamWriter(new FileOutputStream(filePath), StandardCharsets.UTF_8);
        try {
            fw.write(html);
            fw.flush();
        } catch (Exception e) {
    ...
    public static String getImgCode() throws MyException {
        ...
        return imgCode == null ? System.currentTimeMillis() + "" : imgCode;
    }
...
//	}
    ...
    public static boolean isSuperAdmin(String auth) {
        ...
        return ("," + auth + ",").indexOf("," + IConst.C_SUPER + ",") >= 0;
    }
