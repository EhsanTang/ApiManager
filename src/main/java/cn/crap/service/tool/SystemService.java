...
public class SystemService {
    ...
    public void mergeSource() {
        try {
            String allCss = "";
            String cssBaseFileUrl = Tools.getServicePath() + "/META-INF/resources/resources/css/";
            ...
            String allJs = "";
            String jsBaseFileUrl = Tools.getServicePath() + "/META-INF/resources/resources/js/";
    ...
    public void updateSettingCss() throws Exception {
        // 更新css模板，静态化css文件
        String cssPath = Tools.getServicePath() + "/META-INF/resources/resources/css/";
