...
CREATE TABLE `module` (
  ...
  `version` int(11) NOT NULL DEFAULT '0',
  `category` varchar(200) NOT NULL DEFAULT '' COMMENT '文档分类，多个分类以逗号分割，每个分类最多10个字',
  PRIMARY KEY (`id`),
...
CREATE TABLE `project_user` (
  ...
  `addArticle` bit(1) NOT NULL DEFAULT b'1' COMMENT '是否可以添加文档',
  `delArticle` bit(1) NOT NULL DEFAULT b'0' COMMENT '是否可以删除文档',
  `modArticle` bit(1) NOT NULL DEFAULT b'1' COMMENT '是否可以修改文档',
