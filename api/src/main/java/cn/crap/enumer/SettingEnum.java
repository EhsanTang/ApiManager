...
public enum SettingEnum {
    ...
    ICONFONT("ICONFONT", SettingStatus.COMMON, SettingType.SELECT, false, 101, "//at.alicdn.com/t/font_73680_vpe6s2g9sk", "系统图标",
            new String[]{"本地图标地址（服务器不能连接外网时使用）|iconfont", "阿里CDN图标库地址|//at.alicdn.com/t/font_73680_vpe6s2g9sk"}),
